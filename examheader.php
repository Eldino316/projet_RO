...
<style>
  ...
  <b class="caret"></b>
                            ...
                            <li><a href="changepass.php"><i class="fa fa-edit icon"></i> Changer de mots de pass</a>
                            </li>
                            <li class="divider"></li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li><a href="result_count.php" id="endExamBtn"> <i class="fa fa-sign-out fa-fw"></i>Aborter la session</a></li>                      
