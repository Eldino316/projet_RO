...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-third">
        <h5>Développement et Mnagement Internationale</h5>
        <img src="image/Capture.jpg" style="width:80%" alt="Google Regional Map">
      </div>
  ...
  <div class="w3-container">
    <h5>Possibilités d'embauches avec nos Certificats</h5>
