              ...
              <input type="text" name="enroll" onkeyup="val()" class="form-control" id="enrollmentNumber" placeholder="Enrollment No." data-toggle="tooltip" data-placement="right" title="valid enroll" required/>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <label>Select Branch*</label>
                                                    ...
                                                    <option value="Développement et Management International">Développement et Management International</option>
                            <option value="Validations des Acquis et Expériences">Validations des Acquis et Expériences</option>
                            <option value="Théologie Pratiques et Laïc">Théologie Pratiques et Laïc</option>
                        </select>
                                                </div>
                                            </div>
